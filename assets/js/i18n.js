...
(function () {
  ...
  const I18N = {
    ...
    uk: {
      ...
      "werbe.svc4.title": "Друк наклейок та банерів",
      "werbe.svc4.text": "Друк та контурна порізка фігурних наклейок, етикеток для продукції, стікерпаків. А також виготовлення рекламних банерів, сіток (Mesh), прапорів та мобільних стендів Roll-up для виставок та заходів.",
      "werbe.svc4.t1": "Друк стікерів", "werbe.svc4.t2": "Банери & Сітки", "werbe.svc4.t3": "Roll-up стенди",
    ...
    de: {
      ...
      "werbe.svc4.title": "Aufkleber- & Bannerdruck",
      "werbe.svc4.text": "Druck und Konturschnitt von individuellen Aufklebern, Produktetiketten und Sticker-Sets. Zudem Fertigung von Werbebanner, Mesh-Planen, Fahnen und Roll-up-Displays für Messen und Events.",
      "werbe.svc4.t1": "Aufkleber & Sticker", "werbe.svc4.t2": "Banner & Planen", "werbe.svc4.t3": "Roll-up Displays",
    ...
    ru: {
      ...
      "werbe.svc4.title": "Друк наклейок та банерів",
      "werbe.svc4.text": "Печать и контурная резка фигурных наклеек, этикеток для продукции, стикерпаков. А также изготовление рекламных баннеров, сеток (Mesh), флагов и мобильных стендов Roll-up для выставок и мероприятий.",
      "werbe.svc4.t1": "Печать стикеров", "werbe.svc4.t2": "Баннеры & Сетки", "werbe.svc4.t3": "Roll-up стенды",
    ...
    en: {
      ...
      "werbe.svc4.title": "Sticker & Banner Printing",
      "werbe.svc4.text": "Printing and contour cutting of custom stickers, product labels, and sticker sheets. We also produce PVC banners, mesh banners, flags, and roll-up displays for trade shows and events.",
      "werbe.svc4.t1": "Custom Stickers", "werbe.svc4.t2": "Banners & Mesh", "werbe.svc4.t3": "Roll-up Displays",

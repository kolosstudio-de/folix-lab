/* ============================================================
   FOLIX-LAB — i18n
   Translation dictionary, used at build time by scripts/build-i18n.js
   to bake each language into its own static page (/, /uk/, /ru/, /en/).
   German is the only language on the unprefixed root URLs; this file
   no longer decides the page's language at runtime (see applyLang below —
   it always trusts the page's own baked data-lang, never a stored/query one).
...
(function () {
  ...
  const I18N = {
    ...
    uk: {
      ...
      "werbe.process.eyebrow": "Як ми працюємо", "werbe.process.title": "Процес без компромісів",
      "werbe.step1.title": "Консультація та заміри", "werbe.step1.text": "Обговорюємо ідею, оглядаємо об'єкт чи авто, робимо точні заміри та підбираємо рішення.",
      "werbe.step2.title": "Дизайн та прорахунок", "werbe.step2.text": "Підготовка макетів, вибір матеріалів та прозорий кошторис без прихованих витрат.",
      "werbe.step3.title": "Виробництво та монтаж", "werbe.step3.text": "Друк, плоттерна порізка та професійний монтаж на об'єкті або в нашій студії.",
      "werbe.step4.title": "Контроль і здача", "werbe.step4.text": "Ретельна перевірка якості монтажу, передача готового проєкту та рекомендації щодо догляду.",
    ...
    de: {
      ...
      "werbe.process.eyebrow": "So arbeiten wir", "werbe.process.title": "Ein Prozess ohne Kompromisse",
      "werbe.step1.title": "Beratung & Aufmaß", "werbe.step1.text": "Wir besprechen Ihre Idee, begutachten das Objekt oder Fahrzeug, nehmen genau Maß und finden die Lösung.",
      "werbe.step2.title": "Design & Angebot", "werbe.step2.text": "Erstellung von Layouts, Materialauswahl und ein transparentes Angebot ohne versteckte Kosten.",
      "werbe.step3.title": "Produktion & Montage", "werbe.step3.text": "Druck, Plot und fachgerechte Montage vor Ort oder in unserem Studio.",
      "werbe.step4.title": "Kontrolle & Übergabe", "werbe.step4.text": "Sorgfältige Qualitätskontrolle der Montage, Übergabe des fertigen Projekts und Pflegehinweise.",
    ...
    ru: {
      ...
      "werbe.process.eyebrow": "Как мы работаем", "werbe.process.title": "Процесс без компромиссов",
      "werbe.step1.title": "Консультация и замеры", "werbe.step1.text": "Обсуждаем идею, осматриваем объект или авто, делаем точные замеры и подбираем решение.",
      "werbe.step2.title": "Дизайн и расчёт", "werbe.step2.text": "Подготовка макетов, выбор материалов и прозрачная смета без скрытых расходов.",
      "werbe.step3.title": "Производство и монтаж", "werbe.step3.text": "Печать, плоттерная резка и профессиональный монтаж на объекте или в нашей студии.",
      "werbe.step4.title": "Контроль и сдача", "werbe.step4.text": "Тщательная проверка качества монтажа, сдача готового проекта и рекомендации по уходу.",
    ...
    en: {
      ...
      "werbe.process.eyebrow": "How we work", "werbe.process.title": "A process without compromise",
      "werbe.step1.title": "Consultation & Measurement", "werbe.step1.text": "We discuss your idea, inspect the object or vehicle, take exact measurements, and find the right solution.",
      "werbe.step2.title": "Design & Quote", "werbe.step2.text": "Preparation of layouts, material selection, and a transparent quote with no hidden costs.",
      "werbe.step3.title": "Production & Installation", "werbe.step3.text": "Printing, plotting, and professional installation on-site or in our studio.",
      "werbe.step4.title": "Quality Control & Handover", "werbe.step4.text": "Thorough quality check of the installation, handover of the finished project, and care instructions.",
  ...
  // Language is baked per static page (own URL per locale, generated by
  // scripts/build-i18n.js). Always trust the page's own declared language —
  // never a stored choice or a ?lang= query param — so a fresh visit to the
  // root domain is German no matter what. Switching language means
  // navigating to that language's own URL (see the lang menu), not a
  // client-side text swap.
  let lang = document.documentElement.getAttribute("data-lang") || "de";

  function initSwitcherClicks() {
    // no-op: switcher links are real per-language URLs and navigate natively
  }
